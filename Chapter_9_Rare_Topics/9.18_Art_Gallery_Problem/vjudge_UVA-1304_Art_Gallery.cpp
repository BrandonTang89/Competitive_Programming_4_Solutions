/**vjudge -UVA-1304 - Art Gallery
 * Defending the art gallery with 1 guard + getting the area that the guard can stand in.
 * We use the cutpolygon technique together with a function to get the area of the resulting
 * polygon.
 * 
 * Time: O(n), Space: O(n)
 */
