/**Kattis - mincut
 * Standard min-cut problem, avoid self-loops and compress edges. We do Dinic's then BFS on the
 * residual graph.
 *
...
int main()
{
    ...
    vector<int> s_component = mf.mincut(s, t);
    cout << s_component.size() << endl;
    for (auto u : s_component) {
        cout << u << endl;
    }
